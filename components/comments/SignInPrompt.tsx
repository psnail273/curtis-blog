...
export function SignInPrompt() {
  return (
    <div className="border border-border rounded-lg p-6 md:p-8 mb-6 md:mb-8 bg-card text-center">
      <Lock className="size-6 text-muted mx-auto mb-3" aria-hidden="true" />
